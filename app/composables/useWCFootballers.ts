...
export const wcFootballers: WCFootballer[] = [
	...
	{
		name: 'ateyah',
		fullName: 'Noureddin Bani Ateyah',
		country: 'Jordan',
		nationality: 'Jordan',
		position: 'Goalkeeper',
		born: 1993,
